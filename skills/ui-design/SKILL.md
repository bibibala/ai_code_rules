---
name: 'ui-design'
description: 'UI 设计与前端界面规范。做页面/组件/原型/样式与视觉效果时调用，包含设计规格与自检清单。'
---
...
2. Product Interface Planning
3. Aesthetic Direction Determination
4. High-Fidelity UI Design
5. Frontend Prototype Implementation (use professional icon libraries; never emoji as icons)
6. Realism Enhancement (use real materials where possible)
